...
namespace jcamacho_bugtracker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            model.Body = "";
            model.FromName = model.Email;
            model.Subject = "Reset password link";
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    var body = "<p>To reset your password click the link below.</p><br /><br />";
                    body = body + callbackUrl;//"This is a message from your personal site. The name and the email of the contacting person is above";
                    var email = new MailMessage(ConfigurationManager.AppSettings["username"], ConfigurationManager.AppSettings["emailfrom"])
                    {
                        Subject = "Welcome to the bugtracker.",
                        Body = string.Format(body, model.FromName, model.Email, model.Body),
                        IsBodyHtml = true
                    };
